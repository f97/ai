...
//Spark4.0 Ultra request address, domain parameter is 4.0Ultra:
//
//wss://spark-api.xf-yun.com/v4.0/chat
//Spark Max-32K request address, domain parameter is max-32k
//
//wss://spark-api.xf-yun.com/chat/max-32k
//Spark Max request address, domain parameter is generalv3.5
//
//wss://spark-api.xf-yun.com/v3.5/chat
//Spark Pro-128K request address, domain parameter is pro-128k:
//
// wss://spark-api.xf-yun.com/chat/pro-128k
//Spark Pro request address, domain parameter is generalv3:
//
//wss://spark-api.xf-yun.com/v3.1/chat
//Spark Lite request address, domain parameter is lite:
//
